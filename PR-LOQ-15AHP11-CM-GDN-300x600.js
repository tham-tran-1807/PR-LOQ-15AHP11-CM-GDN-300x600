...
lib.ssMetadata = [
		{name:"PR_LOQ_15AHP11_CM_GDN_300x600_atlas_1", frames: [[0,1806,50,50],[0,0,300,600],[0,602,300,600],[0,1204,300,600],[302,0,300,600],[302,602,300,600],[302,1204,300,600],[604,0,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_LOQ_15AHP11_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLOQ15AHP11CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(361).to({_off:false},0).wait(49));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({_off:true},61).wait(49));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(121).to({_off:false},0).to({_off:true},59).wait(230));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(60).to({_off:false},0).to({_off:true},61).wait(289));
...
// library properties:
lib.properties = {
	id: 'D39A4FABD2FD344E9EFD38AA28026B0B',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_LOQ_15AHP11_CM_GDN_300x600_atlas_1.png", id:"PR_LOQ_15AHP11_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['D39A4FABD2FD344E9EFD38AA28026B0B'] = {
